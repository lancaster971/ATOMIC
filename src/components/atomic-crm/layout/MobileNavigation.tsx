      ...
      <DropdownMenu>
        <DropdownMenuTrigger asChild>
          <Button
            ...
            aria-label={translate("crm.misc.create")}
          >
      ...
      <DropdownMenuTrigger asChild>
        ...
        >
          ...
          <span className="text-[0.6rem] font-medium">
            <Translate i18nKey="crm.nav.settings">Settings</Translate>
          </span>
        </Button>
      </DropdownMenuTrigger>
      <DropdownMenuContent>
